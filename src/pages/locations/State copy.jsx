                    ...
                    <tr key={index}>
                      <td className="align-middle bg-transparent border-b whitespace-nowrap shadow-transparent cursor-pointer">
                        <div className="object-contain w-[100px] aspect-square rounded flex items-center">
                          <img
                            src={state.image ? state.image : state.banner}
                            alt={state.name}
                      ...
                      <td
                        ...
                        main-data={JSON.stringify(state)}
                        onClick={viewData}
                      >
                      ...
                      <td className="align-middle bg-transparent border-b whitespace-nowrap shadow-transparent cursor-pointer">
                        <span
                          ...
                          onClick={() => {
                            let status = state?.status === 1 ? 2 : 1;
                            handleStatus(state._id, status);
                          }}
                        >
                      ...
                      <td className=" align-middle bg-transparent border-b whitespace-nowrap">
                        <Action dropList={dropList} data={state} />
                      </td>
                    </tr>
                  ))}
                </tbody>
              ...
              <div className="w-auto">
                <p className="mb-0 fs-6">
                  ...
                  >
                    ...
                    {param.pageNo * param.limit > states?.count
                      ? states?.count
              ...
              <div className="w-auto flex items-center">
                <div className="d-flex justify-content-center align-items-center">
                  <button
                    ...
                    onClick={() => handlePageChange(states?.pagination[0])}
                  >
                    <span className="fas fa-chevron-left" />
                  </button>
                  <ul className="pagination mb-0 mx-1">
                    {states?.pagination?.map((row) => {
                      return (
                        <li key={row}>
                          <button
                  ...
                  <button
                    ...
                    onClick={() =>
                      handlePageChange(
                        states?.pagination[states?.pagination.length - 1]
                      )
                    }
                  >
